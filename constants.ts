...
export const FEATURES: FeatureData[] = [
  {
    ...
    title: '군단장 레이드',
    subtitle: '극한의 협동 전투',
    description: '차원의 균열을 뚫고 혼돈의 군단이 침공합니다. 4인 또는 8인의 정예 수호자로 공격대를 결성하십시오. 치명적인 기믹을 파훼하고 완벽한 팀워크를 발휘해야만 차원의 붕괴를 막을 수 있습니다. 생존은 오직 동료를 향한 신뢰에 달려 있습니다.',
    icon: 'Sword',
  ...
  },
  {
    ...
    title: '생활 & 영지',
    subtitle: '전장 너머의 안식처',
    description: '끝없는 전투 뒤에는 달콤한 휴식이 필요합니다. 전설적인 재료를 채집해 장비를 제작하고, 나만의 영지를 아름답게 가꾸어보세요. 성대한 만찬을 열어 길드원들과 결속을 다지고 전장에 나갈 힘을 얻을 수 있습니다.',
    icon: 'Home',
  ...
  },
  {
    ...
    title: '커스터마이징',
    subtitle: '나만의 개성 완성',
    description: '아르카디아에서 당신의 모습은 곧 전설이 됩니다. 세밀한 염색 시스템과 수천 가지의 코스튬 조합으로 세상에 단 하나뿐인 스타일을 완성하십시오. 전장에서 가장 빛나는 주인공은 바로 당신입니다.',
    icon: 'Palette',
...
export const CLASSES: ClassData[] = [
  // TANKS
  {
    ...
    imageUrls: ['https://i.postimg.cc/mkNcLQFV/아이언_포트.jpg']
  },
  {
    id: 'crusader',
    name: '크루세이더',
    ...
    imageUrls: [
      'https://i.postimg.cc/D0dWvqbg/크루세이더(남).jpg',
      'https://i.postimg.cc/FzgfrjJx/크루세이더(여).jpg'
    ]
  },
  // DEALERS
  {
    ...
    imageUrls: ['https://i.postimg.cc/k4QFkRwW/환영검사.jpg']
  },
  {
    id: 'gladiator',
    name: '광전사',
    ...
    imageUrls: ['https://i.postimg.cc/QtQkRKS5/광전사.jpg']
  },
  {
    id: 'iron-fist',
    name: '무투가',
    ...
    imageUrls: ['https://i.postimg.cc/fLcj6S5k/무투가.jpg']
  },
  {
    id: 'archmage',
    name: '아크메이지',
    ...
    imageUrls: ['https://i.postimg.cc/pTfYg5kj/마법사.jpg']
  },
  {
    id: 'dual-trigger',
    name: '듀얼 트리거',
    ...
    imageUrls: ['https://i.postimg.cc/XJfcTBxZ/듀얼_트리거.jpg']
  },
  {
    id: 'heavy-launcher',
    name: '헤비 런처',
    ...
    imageUrls: ['https://i.postimg.cc/zBCS9Hpy/헤비_런처.jpg']
  },
  {
    id: 'night-walker',
    name: '어쎄신',
    ...
    imageUrls: ['https://i.postimg.cc/26QFPLTV/어쎄신.jpg']
  },
  {
    id: 'grim-reaper',
    name: '그림 리퍼',
    ...
    imageUrls: ['https://i.postimg.cc/wv8QfQ5s/그림_리퍼.jpg']
  },
  // SUPPORTS
  {
    id: 'high-priest',
    ...
    imageUrls: [
      'https://i.postimg.cc/mZQ1yG6k/하이_프리스트(남).jpg',
      'https://i.postimg.cc/kMxRvdh2/하이_프리스트(여).jpg'
    ]
  },
  {
    id: 'minstrel',
    ...
    imageUrls: ['https://i.postimg.cc/PfmvQkF5/민스트럴.jpg']
  },
  {
    id: 'ink-weaver',
    name: '잉크 위버',
    ...
    imageUrls: [
      'https://i.postimg.cc/RCcJLzbS/잉크위버(남).jpg',
      'https://i.postimg.cc/xjKN3SFq/잉크위버(여).jpg'
    ]
  },
  {
    id: 'star-gazer',
    ...
    imageUrls: [
      'https://i.postimg.cc/PJzLXmwn/스타_게이저(남).jpg',
      'https://i.postimg.cc/tJt1qhxQ/스타_게이저(여).jpg'
    ]
  }
];